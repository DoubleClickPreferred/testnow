...
# I did not know how to properly bundle this project and so I had a look at how Gabriel Vergnaud managed his 'ts-pattern project'.
# This file is a copy of https://github.com/gvergnaud/ts-pattern/blob/main/scripts/generate-cts.sh
